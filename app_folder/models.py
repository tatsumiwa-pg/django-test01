...
class Memo(models.Model):
    ...
    register_dttm = models.DateTimeField(verbose_name='registered_datetime', name='register_dttm', max_length=14, null=False, auto_now=True)
    lastupdate_dttm = models.DateTimeField(verbose_name='lastupdate_datetime', name='lastupdate_dttm', max_length=14, null=False, auto_now_add=True)
